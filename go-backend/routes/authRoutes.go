...
func SetupAuthRoutes(app *fiber.App) {
	auth := app.Group("/api/auth", middleware.AuthLimiter)
	...
	auth.Post("/forgot-password", middleware.StrictLimiter, controllers.ForgotPassword)
	auth.Post("/reset-password", middleware.StrictLimiter, controllers.ResetPassword)
